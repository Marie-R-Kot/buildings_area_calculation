...
Подробнее о предобработке и формировании подвыборок можно прочитать в файле `data_prepocessing.ipynb`
...
Подбробнее о модели и лоссах можно прочитать в файле `model_training.ipynb`
...
### Короткая инструкция для деплоя
1. Сколнировать репозиторий на аккаунт github
2. Авторизоваться на streamlit в свой аккаунт github
3. Выполнить цепочку следующих команд:

    - Create app 
    - Deploy a public app from GitHub 
    - Выбрать склонированный репозиторий 
    - Оставить все параметры по умолчанию 
    - В Advanced settings выбрать Python 3.11 
